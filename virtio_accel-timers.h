#ifndef _VIRTIO_ACCEL_TIMERS_H
#define _VIRTIO_ACCEL_TIMERS_H
...
#ifdef TIMERS
#define virtaccel_timer_init(vaccel) hash_init(vaccel->timers);
#define virtaccel_timer_free(vaccel) virtaccel_timer_del_all(vaccel);
#else
#define virtaccel_timer_init(vaccel)
#define virtaccel_timer_free(vaccel)
#endif
